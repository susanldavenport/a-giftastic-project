Week 6 Bootcamp Project featuring APIs and AJAX
# GifTastic

I had a lot of fun completing this project. Who doesn't like Gifs!? 
I hope to be able to return to complete some of the bonus work and tweak it a little further.
...
1. **Hit the GIPHY API**.
   ...
   * Like many APIs, GIPHY requires developers to use a key to access their API data. To use the GIPHY API, you'll need a GIPHY account (don't worry, it's free!) and then obtain an API Key by [creating an app](https://developers.giphy.com/dashboard/?create=true).
    API KEY = mqKIR6ZY8blFSFVvyMcV1maZ8CQ0fHaN
